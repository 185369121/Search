...
- (void)viewDidLoad {
    ...
    for (NSString *name in array) {
        ...
        star.name = name;
        star.phone = [NSString stringWithFormat:@"152010618%2d",arc4random()%100];
    ...
    self.search.searchType = LYSearchWithChineseInitials | LYSearchWithChinesePinyin | LYSearchWithChineseChineseAndPinyin;
